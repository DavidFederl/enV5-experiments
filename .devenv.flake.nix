...
devenv_root = "/Users/david.federl/Repositories/elastic-ai/base-prj";
devenv_dotfile = ./.devenv;
devenv_dotfile_string = ".devenv";
container_name = null;
devenv_tmpdir = "/var/folders/3x/57ymk82s50v1w_vbhcnpn_h00000gn/T/";
devenv_runtime = "/var/folders/3x/57ymk82s50v1w_vbhcnpn_h00000gn/T/devenv-a3b8a1c";
